...
export const REJECTION_CODES = ["ALIEXPRESS_RATING_TOO_LOW", "ALIEXPRESS_REVIEWS_TOO_LOW", "ALIEXPRESS_ORDERS_TOO_LOW", "EBAY_RECENT_SALES_TOO_LOW", "EBAY_SOLD_HISTORY_UNAVAILABLE", "MATCH_CONFIDENCE_TOO_LOW", "NO_QUALIFIED_ALIEXPRESS_SOURCE", "VISUAL_MATCH_TOO_LOW", "MARGIN_TOO_LOW", "MISSING_SHIPPING_COST", "STALE_DATA", "MANUAL_INTERVENTION_REQUIRED"] as const;
