...
export const CANDIDATE_STATUSES = ["DISCOVERED", "COLLECTING", "ALIEXPRESS_REJECTED", "EBAY_MATCH_REQUIRED", "EBAY_MATCHED", "DEMAND_NOT_VERIFIED", "NEEDS_MANUAL_VALIDATION", "UNPROFITABLE", "APPROVED", "EXPORT_PENDING", "EXPORTED", "DATA_SOURCE_FAILED"] as const;

export type CandidateStatus = (typeof CANDIDATE_STATUSES)[number];

export const REJECTION_CODES = ["ALIEXPRESS_RATING_TOO_LOW", "ALIEXPRESS_REVIEWS_TOO_LOW", "ALIEXPRESS_ORDERS_TOO_LOW", "EBAY_RECENT_SALES_TOO_LOW", "EBAY_SOLD_HISTORY_UNAVAILABLE", "MATCH_CONFIDENCE_TOO_LOW", "NO_QUALIFIED_ALIEXPRESS_SOURCE", "SOURCE_PRICE_NOT_BELOW_EBAY", "VISUAL_MATCH_TOO_LOW", "VISUAL_MATCH_UNAVAILABLE", "MARGIN_TOO_LOW", "MISSING_SHIPPING_COST", "STALE_DATA", "MANUAL_INTERVENTION_REQUIRED"] as const;
